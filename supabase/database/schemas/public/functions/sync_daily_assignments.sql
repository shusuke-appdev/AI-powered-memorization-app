CREATE FUNCTION public.sync_daily_assignments (
  p_user_id         uuid,
...
REVOKE ALL ON FUNCTION public.sync_daily_assignments(uuid, date, uuid[]) FROM PUBLIC;

GRANT ALL ON FUNCTION public.sync_daily_assignments(uuid, date, uuid[]) TO service_role;